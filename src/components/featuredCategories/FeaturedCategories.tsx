...
const FeaturedCategories = () => {
    return (
        <div className='py-5 px-16 hidden lg:flex flex-col'>
            <div>
                <span className='flex font-calibri text-2xl items-center gap-2'>
                    <FaShoppingBag className='h-6 w-6 flex-none text-text-puropelo' />
            ...
            <div className='flex justify-between gap-3 mt-8'>
                {categories.map((category, index) => (
                    <a href={category.href} className='text-center' key={index}>
                        <div
                            className="flex rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 flex-col max-w-sm p-3 h-96 hover:bg-[#ECCC9F] transition duration-300 hover:scale-110"
                        >
